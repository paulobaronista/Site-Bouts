 ...
 */
class BaseTipo extends \Base\Entity\BaseTipo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\BaseTipo' . "\0" . 'idtipo', '' . "\0" . 'Base\\Entity\\BaseTipo' . "\0" . 'nome');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BaseTipo $proxy) {
